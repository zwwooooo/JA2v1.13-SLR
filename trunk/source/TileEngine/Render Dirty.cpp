...
//SGPRect		gDirtyClipRect = { 0, 0, __max(1024,SCREEN_WIDTH_BIG), __max(768,SCREEN_HEIGHT_BIG) }; //zwwooooo: Big resolution: 调整分辨率后需要调整此参数同大，不然鼠标无法显示超过1024*768区域
SGPRect		gDirtyClipRect = { 0, 0, 1920, 1080 }; //zwwooooo: Big resolution: 调整分辨率后需要调整此参数同大，不然鼠标无法显示超过1024*768区域
