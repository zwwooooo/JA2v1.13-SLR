...
void InitRadarScreenCoords( )
{
		...
		RADAR_WINDOW_STRAT_X = (SCREEN_WIDTH_1024 - 97);//zwwooooo: Big resolution: 战略界面小地图位置 x 坐标
		RADAR_WINDOW_STRAT_Y = (SCREEN_HEIGHT_768 - 107);//zwwooooo: Big resolution: 战略界面小地图位置 y 坐标
}
