  ...
  fDisplayOverheadMap = TRUE;
	...
	else if (iResolution == 2)
	{
		...
		if (iResolution_BIG == 3) {
			strcpy( VObjectDesc.ImageFile, "INTERFACE\\inventory_bottom_panel_1280x768.STI" );
		} else if (iResolution_BIG == 4) {
			strcpy( VObjectDesc.ImageFile, "INTERFACE\\inventory_bottom_panel_1280x800.STI" );
		} else if (iResolution_BIG == 5) {
			strcpy( VObjectDesc.ImageFile, "INTERFACE\\inventory_bottom_panel_1280x960.STI" );
		} else if (iResolution_BIG == 6) {
			strcpy( VObjectDesc.ImageFile, "INTERFACE\\inventory_bottom_panel_1280x1024.STI" );
		} else if (iResolution_BIG == 7) {
			strcpy( VObjectDesc.ImageFile, "INTERFACE\\inventory_bottom_panel_1360x768.STI" );
		} else if (iResolution_BIG == 8) {
			strcpy( VObjectDesc.ImageFile, "INTERFACE\\inventory_bottom_panel_1366x768.STI" );
		} else if (iResolution_BIG == 9) {
			strcpy( VObjectDesc.ImageFile, "INTERFACE\\inventory_bottom_panel_1400x1050.STI" );
		} else if (iResolution_BIG == 10) {
			strcpy( VObjectDesc.ImageFile, "INTERFACE\\inventory_bottom_panel_1600x900.STI" );
		} else if (iResolution_BIG == 11) {
			strcpy( VObjectDesc.ImageFile, "INTERFACE\\inventory_bottom_panel_1680x1050.STI" );
		} else if (iResolution_BIG == 12) {
			strcpy( VObjectDesc.ImageFile, "INTERFACE\\inventory_bottom_panel_1920x1080.STI" );
		} else {
			strcpy( VObjectDesc.ImageFile, "INTERFACE\\inventory_bottom_panel_1024x768.STI" );
		}
	...
	switch (iResolution)
	{
		...
		case 2:
			if (gGameOptions.ubSquadSize > 8)
			{
				...
				//zwwooooo: Big resolution: 根据分辨率来选择界面sti文件名称 -->
				if (iResolution_BIG == 3) {
					FilenameForBPP("INTERFACE\\bottom_bar_10_1280x768.STI", VObjectDesc.ImageFile);
				} else if (iResolution_BIG == 4) {
					FilenameForBPP("INTERFACE\\bottom_bar_10_1280x800.STI", VObjectDesc.ImageFile);
				} else if (iResolution_BIG == 5) {
					FilenameForBPP("INTERFACE\\bottom_bar_10_1280x960.STI", VObjectDesc.ImageFile);
				} else if (iResolution_BIG == 6) {
					FilenameForBPP("INTERFACE\\bottom_bar_10_1280x1024.STI", VObjectDesc.ImageFile);
				} else if (iResolution_BIG == 7) {
					FilenameForBPP("INTERFACE\\bottom_bar_10_1360x768.STI", VObjectDesc.ImageFile);
				} else if (iResolution_BIG == 8) {
					FilenameForBPP("INTERFACE\\bottom_bar_10_1366x768.STI", VObjectDesc.ImageFile);
				} else if (iResolution_BIG == 9) {
					FilenameForBPP("INTERFACE\\bottom_bar_10_1400x1050.STI", VObjectDesc.ImageFile);
				} else if (iResolution_BIG == 10) {
					FilenameForBPP("INTERFACE\\bottom_bar_10_1600x900.STI", VObjectDesc.ImageFile);
				} else if (iResolution_BIG == 11) {
					FilenameForBPP("INTERFACE\\bottom_bar_10_1680x1050.STI", VObjectDesc.ImageFile);
				} else if (iResolution_BIG == 12) {
					FilenameForBPP("INTERFACE\\bottom_bar_10_1920x1080.STI", VObjectDesc.ImageFile);
				} else {
					FilenameForBPP("INTERFACE\\bottom_bar_10_1024x768.STI", VObjectDesc.ImageFile);
				}
				// <-- zwwooooo: Big resolution
			...
			else if (gGameOptions.ubSquadSize > 6)
			{
				...
				//zwwooooo: Big resolution: 根据分辨率来选择界面sti文件名称 -->
				if (iResolution_BIG == 3) {
					FilenameForBPP("INTERFACE\\bottom_bar_8_1280x768.STI", VObjectDesc.ImageFile);
				} else if (iResolution_BIG == 4) {
					FilenameForBPP("INTERFACE\\bottom_bar_8_1280x800.STI", VObjectDesc.ImageFile);
				} else if (iResolution_BIG == 5) {
					FilenameForBPP("INTERFACE\\bottom_bar_8_1280x960.STI", VObjectDesc.ImageFile);
				} else if (iResolution_BIG == 6) {
					FilenameForBPP("INTERFACE\\bottom_bar_8_1280x1024.STI", VObjectDesc.ImageFile);
				} else if (iResolution_BIG == 7) {
					FilenameForBPP("INTERFACE\\bottom_bar_8_1360x768.STI", VObjectDesc.ImageFile);
				} else if (iResolution_BIG == 8) {
					FilenameForBPP("INTERFACE\\bottom_bar_8_1366x768.STI", VObjectDesc.ImageFile);
				} else if (iResolution_BIG == 9) {
					FilenameForBPP("INTERFACE\\bottom_bar_8_1400x1050.STI", VObjectDesc.ImageFile);
				} else if (iResolution_BIG == 10) {
					FilenameForBPP("INTERFACE\\bottom_bar_8_1600x900.STI", VObjectDesc.ImageFile);
				} else if (iResolution_BIG == 11) {
					FilenameForBPP("INTERFACE\\bottom_bar_8_1680x1050.STI", VObjectDesc.ImageFile);
				} else if (iResolution_BIG == 12) {
					FilenameForBPP("INTERFACE\\bottom_bar_8_1920x1080.STI", VObjectDesc.ImageFile);
				} else {
					FilenameForBPP("INTERFACE\\bottom_bar_8_1024x768.STI", VObjectDesc.ImageFile);
				}
				// <-- zwwooooo: Big resolution
...
BOOLEAN HandleKlerykPistolet( SOLDIERTYPE *pSoldier, UINT32 uiHandPos, UINT16 usReplaceItem )
{
	...
	if ( pSoldier->ubProfile == 57 )
	{
		if ( uiHandPos == HANDPOS || uiHandPos == SECONDHANDPOS )
		{
			...
			{	//legion
				// Do we have nothing or the leather vest or kevlar leather vest?
				if ( usReplaceItem == 4520 ) //z硂ty pistolet items.xml
				{
					// This is good....
					fRefuse = FALSE;
				}
