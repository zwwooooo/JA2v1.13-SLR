...
#define			CLOCK_X							(SCREEN_WIDTH_1024 - 86)			//554
#define			CLOCK_Y							(SCREEN_HEIGHT_768 - 21)		//459

// the mouse region around the clock (bigger)
#define			CLOCK_REGION_START_X			(SCREEN_WIDTH_1024 - 88)								//552
#define			CLOCK_REGION_START_Y			(SCREEN_HEIGHT_768 - 24)							//456
#define			CLOCK_REGION_WIDTH				((SCREEN_WIDTH_1024 - 20) - CLOCK_REGION_START_X)	// ( 620 - CLOCK_REGION_START_X )
#define			CLOCK_REGION_HEIGHT				((SCREEN_HEIGHT_768 - 12) - CLOCK_REGION_START_Y)	//( 468 - CLOCK_REGION_START_Y )
