...
*/
	...
	RestoreExternBackgroundRect( MAP_BORDER_X, MAP_BORDER_Y, SCREEN_WIDTH_1024 - MAP_BORDER_X, SCREEN_HEIGHT_768 );
...
void InitMapBorderButtonCoordinates()
{
	...
	MAP_BORDER_TOWN_BTN_X = MAP_BORDER_X + ((SCREEN_WIDTH_1024 - MAP_BORDER_X) / 2 - 152);
	MAP_BORDER_TOWN_BTN_Y = (SCREEN_HEIGHT_768 - buttonOffset);
	MAP_BORDER_MINE_BTN_X = MAP_BORDER_X + ((SCREEN_WIDTH_1024 - MAP_BORDER_X) / 2 - 109);
	MAP_BORDER_MINE_BTN_Y = (SCREEN_HEIGHT_768 - buttonOffset);
	MAP_BORDER_TEAMS_BTN_X = MAP_BORDER_X + ((SCREEN_WIDTH_1024 - MAP_BORDER_X) / 2 - 66);
	MAP_BORDER_TEAMS_BTN_Y = (SCREEN_HEIGHT_768 - buttonOffset);
	MAP_BORDER_AIRSPACE_BTN_X = MAP_BORDER_X + ((SCREEN_WIDTH_1024 - MAP_BORDER_X) / 2 + 20);
	MAP_BORDER_AIRSPACE_BTN_Y = (SCREEN_HEIGHT_768 - buttonOffset);
	MAP_BORDER_ITEM_BTN_X = MAP_BORDER_X + ((SCREEN_WIDTH_1024 - MAP_BORDER_X) / 2 + 63);
	MAP_BORDER_ITEM_BTN_Y = (SCREEN_HEIGHT_768 - buttonOffset);
	MAP_BORDER_MILITIA_BTN_X = MAP_BORDER_X + ((SCREEN_WIDTH_1024 - MAP_BORDER_X) / 2 - 23);
	MAP_BORDER_MILITIA_BTN_Y = (SCREEN_HEIGHT_768 - buttonOffset);
	MAP_BORDER_MOBILE_BTN_X = 0;
	MAP_BORDER_MOBILE_BTN_Y = 0;

	MAP_LEVEL_MARKER_X = (MAP_BORDER_X + ((SCREEN_WIDTH_1024 - MAP_BORDER_X) / 2 + 114));
	MAP_LEVEL_MARKER_Y = (SCREEN_HEIGHT_768 - buttonOffset);						//(SCREEN_HEIGHT_768 - 157)		//323
	MAP_LEVEL_MARKER_DELTA = 8;
	MAP_LEVEL_MARKER_WIDTH = 55;	//( (SCREEN_WIDTH_1024 - 20) - MAP_LEVEL_MARKER_X )

	if (gGameExternalOptions.gfAllowMilitiaGroups)
	{
		// Mobile button appears next to Militia button.
		MAP_BORDER_MOBILE_BTN_X = MAP_BORDER_X + ((SCREEN_WIDTH_1024 - MAP_BORDER_X) / 2 + 16);
		MAP_BORDER_MOBILE_BTN_Y = (SCREEN_HEIGHT_768 - buttonOffset);

		// Airspace, Items, ZLevel buttons all moved to the right (+22px, +22px, +10px).
		MAP_BORDER_AIRSPACE_BTN_X = MAP_BORDER_X + ((SCREEN_WIDTH_1024 - MAP_BORDER_X) / 2 + 42);
		MAP_BORDER_ITEM_BTN_X = MAP_BORDER_X + ((SCREEN_WIDTH_1024 - MAP_BORDER_X) / 2 + 85);

		MAP_LEVEL_MARKER_X = (MAP_BORDER_X + ((SCREEN_WIDTH_1024 - MAP_BORDER_X) / 2 + 124));
	}
}
