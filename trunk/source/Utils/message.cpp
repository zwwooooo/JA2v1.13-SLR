...
void MapScreenMessage( UINT16 usColor, UINT8 ubPriority, STR16 pStringA, ... )
{
	...
	MAP_LINE_WIDTH = (SCREEN_WIDTH_1024 - 330); //zwwooooo: Big resolution: SCREEN_WIDTH调整为SCREEN_WIDTH_1024 <= 1024
...
void DisplayStringsInMapScreenMessageList( void )
{
	...
	sY = (SCREEN_HEIGHT - 103 - (SCREEN_HEIGHT_BIG - 768)); //zwwooooo: Big resolution: 调整战略地图界面左下角信息显示位置
