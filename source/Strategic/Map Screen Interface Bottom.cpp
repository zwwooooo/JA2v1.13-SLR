...
#define MAP_BOTTOM_Y							(SCREEN_HEIGHT_768 - 121)	//359

//#define MESSAGE_SCROLL_AREA_START_X				(SCREEN_WIDTH_1024 - 534)	//330
//#define MESSAGE_SCROLL_AREA_END_X				(SCREEN_WIDTH_1024 - 522)	//344
#define MESSAGE_SCROLL_AREA_WIDTH				( MESSAGE_SCROLL_AREA_END_X - MESSAGE_SCROLL_AREA_START_X + 1 )

#define MESSAGE_SCROLL_AREA_START_Y				(SCREEN_HEIGHT_768 - 90)	//390
#define MESSAGE_SCROLL_AREA_END_Y				(SCREEN_HEIGHT_768 - 32)		//448
...
void RenderMapScreenInterfaceBottom( BOOLEAN fForceMapscreenFullRender )
{
	...
	if ( fMapScreenBottomDirty || !fShowInventoryFlag )
	{
		...
		// invalidate region
		RestoreExternBackgroundRect( MAP_BOTTOM_X, MAP_BOTTOM_Y, SCREEN_WIDTH_1024 - MAP_BOTTOM_X, SCREEN_HEIGHT_768 - MAP_BOTTOM_Y );
...
BOOLEAN CreateButtonsForMapScreenInterfaceBottom( void )
{
	...
	guiMapBottomExitButtons[ MAP_EXIT_TO_LAPTOP ] = QuickCreateButton( guiMapBottomExitButtonsImage[ MAP_EXIT_TO_LAPTOP ], (SCREEN_WIDTH_1024 - 184), (SCREEN_HEIGHT_768 - 70),
	...
	guiMapBottomExitButtons[ MAP_EXIT_TO_TACTICAL ] = QuickCreateButton( guiMapBottomExitButtonsImage[ MAP_EXIT_TO_TACTICAL ], (SCREEN_WIDTH_1024 - 144), (SCREEN_HEIGHT_768 - 70),
										BUTTON_TOGGLE, MSYS_PRIORITY_HIGHEST - 1,
	...
	guiMapBottomExitButtons[ MAP_EXIT_TO_OPTIONS ] = QuickCreateButton( guiMapBottomExitButtonsImage[ MAP_EXIT_TO_OPTIONS ], (SCREEN_WIDTH_1024 - 182), (SCREEN_HEIGHT_768 - 108),
										BUTTON_TOGGLE, MSYS_PRIORITY_HIGHEST - 1,
	...
	guiMapBottomTimeButtons[ MAP_TIME_COMPRESS_MORE ] = QuickCreateButton( guiMapBottomTimeButtonsImage[ MAP_TIME_COMPRESS_MORE ], (SCREEN_WIDTH_1024 - 112), (SCREEN_HEIGHT_768 - 24),
	...
	guiMapBottomTimeButtons[ MAP_TIME_COMPRESS_LESS ] = QuickCreateButton( guiMapBottomTimeButtonsImage[ MAP_TIME_COMPRESS_LESS ], (SCREEN_WIDTH_1024 - 174), (SCREEN_HEIGHT_768 - 24),
										BUTTON_TOGGLE, MSYS_PRIORITY_HIGHEST - 2,
...
//  guiMapMessageScrollButtons[ MAP_SCROLL_MESSAGE_UP ] = QuickCreateButton( guiMapMessageScrollButtonsImage[ MAP_SCROLL_MESSAGE_UP ], (SCREEN_WIDTH_1024 - 533), (SCREEN_HEIGHT_768 - 109), 
//										BUTTON_TOGGLE, MSYS_PRIORITY_HIGHEST - 1,
...
//  guiMapMessageScrollButtons[ MAP_SCROLL_MESSAGE_DOWN ] = QuickCreateButton( guiMapMessageScrollButtonsImage[ MAP_SCROLL_MESSAGE_DOWN ], (SCREEN_WIDTH_1024 - 533), (SCREEN_HEIGHT_768 - 28), 
//										BUTTON_TOGGLE, MSYS_PRIORITY_HIGHEST - 1,
...
// HEADROCK HAM 3.6: Message window is now as wide as possible.
	...
	guiMapMessageScrollButtons[ MAP_SCROLL_MESSAGE_UP ] = QuickCreateButton( guiMapMessageScrollButtonsImage[ MAP_SCROLL_MESSAGE_UP ], (SCREEN_WIDTH_1024 - 306), (SCREEN_HEIGHT_768 - 109),
										BUTTON_TOGGLE, MSYS_PRIORITY_HIGHEST - 1,
										(GUI_CALLBACK)BtnGenericMouseMoveButtonCallback, (GUI_CALLBACK)BtnMessageUpMapScreenCallback);
	guiMapMessageScrollButtons[ MAP_SCROLL_MESSAGE_DOWN ] = QuickCreateButton( guiMapMessageScrollButtonsImage[ MAP_SCROLL_MESSAGE_DOWN ], (SCREEN_WIDTH_1024 - 306), (SCREEN_HEIGHT_768 - 28),
										BUTTON_TOGGLE, MSYS_PRIORITY_HIGHEST - 1,
										(GUI_CALLBACK)BtnGenericMouseMoveButtonCallback, (GUI_CALLBACK)BtnMessageDownMapScreenCallback);
...
void DrawNameOfLoadedSector( void )
{
	...
	SetFontDestBuffer( FRAME_BUFFER, 0, 0, SCREEN_WIDTH_1024, SCREEN_HEIGHT_768, FALSE );
	...
	VarFindFontCenterCoordinates( (SCREEN_WIDTH_1024 - 92), (SCREEN_HEIGHT_768 - 55), 80, 16, COMPFONT, &sFontX, &sFontY, sString );
...
void DisplayCompressMode( void )
{
	...
	RestoreExternBackgroundRect( (SCREEN_WIDTH_1024 - 151), (SCREEN_HEIGHT_768 - 24), 63, 13 );
	...
	FindFontCenterCoordinates( (SCREEN_WIDTH_1024 - 151), (SCREEN_HEIGHT_768 - 24), 33, 13, sString, COMPFONT, &sX, &sY );
...
void CreateCompressModePause( void )
{
	...
	MSYS_DefineRegion( &gMapPauseRegion, (SCREEN_WIDTH_1024 - 153), (SCREEN_HEIGHT_768 - 24), (SCREEN_WIDTH_1024 - 118), (SCREEN_HEIGHT_768 - 13), MSYS_PRIORITY_HIGH,
							MSYS_NO_CURSOR, MSYS_NO_CALLBACK, CompressModeClickCallback );
...
void DisplayCurrentBalanceTitleForMapBottom( void )
{
	...
	// ste the font buffer
	SetFontDestBuffer( guiSAVEBUFFER, 0, 0, SCREEN_WIDTH_1024, SCREEN_HEIGHT_768, FALSE );
	...
	//VarFindFontCenterCoordinates( (SCREEN_WIDTH_1024 - 637), (SCREEN_HEIGHT_768 - 107),  78, 10,  COMPFONT, &sFontX, &sFontY, sString );
	// CHRISL: Use this if we want to display from the left edge
	//VarFindFontCenterCoordinates( 359, (SCREEN_HEIGHT_768 - 107),  78, 10,  COMPFONT, &sFontX, &sFontY, sString );
	// HEADROCK HAM 3.6: The balance/income box has been moved to the right side, near the laptop button.
	VarFindFontCenterCoordinates( (SCREEN_WIDTH_1024 - 278), (SCREEN_HEIGHT_768 - 111), 78, 10, COMPFONT, &sFontX, &sFontY, sString );
	...
	// center it
	// CHRISL: Replaced X coordinate with dynamic coordinate set from right edge of screen
	//VarFindFontCenterCoordinates( (SCREEN_WIDTH_1024 - 637), (SCREEN_HEIGHT_768 - 61),  78, 10,  COMPFONT, &sFontX, &sFontY, sString );
	// CHRISL: Use this if we want to display from the left edge
	//VarFindFontCenterCoordinates( 359, (SCREEN_HEIGHT_768 - 61),  78, 10,  COMPFONT, &sFontX, &sFontY, sString );
	// HEADROCK HAM 3.6: The balance/income box has been moved to the right side, near the laptop button.	
	VarFindFontCenterCoordinates( (SCREEN_WIDTH_1024 - 278), (SCREEN_HEIGHT_768 - 74), 78, 10, COMPFONT, &sFontX, &sFontY, sString );
	...
	// account.
	VarFindFontCenterCoordinates( (SCREEN_WIDTH_1024 - 278), (SCREEN_HEIGHT_768 - 37), 78, 10, COMPFONT, &sFontX, &sFontY, sString );
...
void DisplayCurrentBalanceForMapBottom( void )
{
	...
	// center it
	// CHRISL: Replaced X coordinate with dynamic coordinate set from right edge of screen
	//VarFindFontCenterCoordinates( (SCREEN_WIDTH_1024 - 637), (SCREEN_HEIGHT_768 - 91),  78, 10,  COMPFONT, &sFontX, &sFontY, sString );
	// CHRISL: Use this if we want to display from the left edge
	//VarFindFontCenterCoordinates( 359, (SCREEN_HEIGHT_768 - 91),  78, 10,  COMPFONT, &sFontX, &sFontY, sString );
	// HEADROCK HAM 3.6: The balance/income box has been moved to the right side, near the laptop button.	
	VarFindFontCenterCoordinates( (SCREEN_WIDTH_1024 - 278), (SCREEN_HEIGHT_768 - 95), 78, 10, COMPFONT, &sFontX, &sFontY, sString );
...
void CreateDestroyMouseRegionMasksForTimeCompressionButtons( void )
{
	...
	if( ( fDisabled ) && ( fCreated == FALSE ) )
	{
		...
		// mask over compress more button
		MSYS_DefineRegion( &gTimeCompressionMask[ 0 ], (SCREEN_WIDTH_1024 - 112), (SCREEN_HEIGHT_768 - 24), (SCREEN_WIDTH_1024 - 112) + 13, (SCREEN_HEIGHT_768 - 24) + 14, MSYS_PRIORITY_HIGHEST - 1,
							MSYS_NO_CURSOR, MSYS_NO_CALLBACK, CompressMaskClickCallback );

		// mask over compress less button
		MSYS_DefineRegion( &gTimeCompressionMask[ 1 ], (SCREEN_WIDTH_1024 - 174), (SCREEN_HEIGHT_768 - 24), (SCREEN_WIDTH_1024 - 174) + 13, (SCREEN_HEIGHT_768 - 24) + 14, MSYS_PRIORITY_HIGHEST - 1,
							MSYS_NO_CURSOR, MSYS_NO_CALLBACK, CompressMaskClickCallback );

		// mask over pause game button
		MSYS_DefineRegion( &gTimeCompressionMask[ 2 ], (SCREEN_WIDTH_1024 - 153), (SCREEN_HEIGHT_768 - 24), (SCREEN_WIDTH_1024 - 118), (SCREEN_HEIGHT_768 - 13), MSYS_PRIORITY_HIGHEST - 1,
							MSYS_NO_CURSOR, MSYS_NO_CALLBACK, CompressMaskClickCallback );
...
void DisplayProjectedDailyMineIncome( void )
{
	...
	// center it
	// CHRISL: Replaced X coordinate with dynamic coordinate set from right edge of screen
	//VarFindFontCenterCoordinates( (SCREEN_WIDTH_1024 - 637), (SCREEN_HEIGHT_768 - 45),  78, 10,  COMPFONT, &sFontX, &sFontY, sString );
	// CHRISL: Use this if we want to display from the left edge
	//VarFindFontCenterCoordinates( 359, (SCREEN_HEIGHT_768 - 45),  78, 10,  COMPFONT, &sFontX, &sFontY, sString );
	// HEADROCK HAM 3.6: The balance/income box has been moved to the right side, near the laptop button.	
	VarFindFontCenterCoordinates( (SCREEN_WIDTH_1024 - 278), (SCREEN_HEIGHT_768 - 58), 78, 10, COMPFONT, &sFontX, &sFontY, sString );
...
void DisplayProjectedDailyExpenses( void )
{
	...
	// center it
	VarFindFontCenterCoordinates( (SCREEN_WIDTH_1024 - 278), (SCREEN_HEIGHT_768 - 21), 78, 10, COMPFONT, &sFontX, &sFontY, sString );
			...
			switch ( gbExitingMapScreenToWhere )
			{
				case MAP_EXIT_TO_LAPTOP:
					...
					{ //Then initiate the transition animation from the mapscreen to laptop...
						...
						BlitBufferToBuffer( FRAME_BUFFER, guiEXTRABUFFER, 0, 0, SCREEN_WIDTH_1024, SCREEN_HEIGHT_768 );
...
{
	// HEADROCK HAM 3.6: Message window is now as wide as possible.
	MESSAGE_SCROLL_AREA_START_X = SCREEN_WIDTH_1024 - 307;
	MESSAGE_SCROLL_AREA_END_X = SCREEN_WIDTH_1024 - 293;
}
