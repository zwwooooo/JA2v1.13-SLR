...
void GetRuntimeSettings( )
{
	...
	switch (iResolution)
	{
		...
		case 0:
			iResX = 640;
			iResY = 480;
			//zwwooooo: Big resolution: 保证640*480不出错 -->
			SCREEN_WIDTH_1024 = 640;
			SCREEN_HEIGHT_768 = 480;
			iResolution_BIG = 0;
			SCREEN_WIDTH_BIG = iResX;
			SCREEN_HEIGHT_BIG = iResY;
		...
		case 2:
			iResX = 1024;
			iResY = 768;
			//zwwooooo: Big resolution: 保证800*600不出错 -->
			SCREEN_WIDTH_1024 = 1024;
			SCREEN_HEIGHT_768 = 768;
			iResolution_BIG = 0;
			SCREEN_WIDTH_BIG = iResX;
			SCREEN_HEIGHT_BIG = iResY;
			//zwwooooo: Big resolution <--
			break;
		// 1280x768
		case 3: //zwwooooo: Big resolution: 调整游戏分辨率
			iResX = 1280;
			iResY = 768;
			iResolution = 2; //iResolution在大于1024x768分辨率时赋值为2，保证不修改的sti界面图片调用原来的1024*768对应的界面图片
			SCREEN_WIDTH_1024 = 1024;
			SCREEN_HEIGHT_768 = 768;
			iResolution_BIG = 3;
			SCREEN_WIDTH_BIG = iResX;
			...
			break;
		// 1280x800
		case 4: //zwwooooo: Big resolution: 调整游戏分辨率
			iResX = 1280;
			iResY = 800;
			iResolution = 2; //iResolution在大于1024x768分辨率时赋值为2，保证不修改的sti界面图片调用原来的1024*768对应的界面图片
			SCREEN_WIDTH_1024 = 1024;
			...
			break;
		// 1280x960
		case 5: //zwwooooo: Big resolution: 调整游戏分辨率
			iResX = 1280;
			iResY = 960;
			iResolution = 2; //iResolution在大于1024x768分辨率时赋值为2，保证不修改的sti界面图片调用原来的1024*768对应的界面图片
			SCREEN_WIDTH_1024 = 1024;
			...
			break;
		// 1280x1024
		case 6: //zwwooooo: Big resolution: 调整游戏分辨率
			iResX = 1280;
			iResY = 1024;
			iResolution = 2; //iResolution在大于1024x768分辨率时赋值为2，保证不修改的sti界面图片调用原来的1024*768对应的界面图片
			SCREEN_WIDTH_1024 = 1024;
			...
			break;
		// 1360x768
		case 7: //zwwooooo: Big resolution: 调整游戏分辨率
			iResX = 1360;
			iResY = 768;
			iResolution = 2; //iResolution在大于1024x768分辨率时赋值为2，保证不修改的sti界面图片调用原来的1024*768对应的界面图片
			SCREEN_WIDTH_1024 = 1024;
			...
			break;
		// 1366x768
		case 8: //zwwooooo: Big resolution: 调整游戏分辨率
			iResX = 1366;
			iResY = 768;
			iResolution = 2; //iResolution在大于1024x768分辨率时赋值为2，保证不修改的sti界面图片调用原来的1024*768对应的界面图片
			SCREEN_WIDTH_1024 = 1024;
			...
			break;
		// 1400x1050
		case 9: //zwwooooo: Big resolution: 调整游戏分辨率
			iResX = 1400;
			iResY = 1050;
			iResolution = 2; //iResolution在大于1024x768分辨率时赋值为2，保证不修改的sti界面图片调用原来的1024*768对应的界面图片
			SCREEN_WIDTH_1024 = 1024;
			...
			break;
		// 1600x900
		case 10: //zwwooooo: Big resolution: 调整游戏分辨率
			iResX = 1600;
			iResY = 900;
			iResolution = 2; //iResolution在大于1024x768分辨率时赋值为2，保证不修改的sti界面图片调用原来的1024*768对应的界面图片
			SCREEN_WIDTH_1024 = 1024;
			...
			break;
		// 1680x1050
		case 11: //zwwooooo: Big resolution: 调整游戏分辨率
			iResX = 1680;
			iResY = 1050;
			iResolution = 2; //iResolution在大于1024x768分辨率时赋值为2，保证不修改的sti界面图片调用原来的1024*768对应的界面图片
			SCREEN_WIDTH_1024 = 1024;
			...
			break;
		// 1920x1080
		case 12: //zwwooooo: Big resolution: 调整游戏分辨率
			iResX = 1920;
			iResY = 1080;
			iResolution = 2; //iResolution在大于1024x768分辨率时赋值为2，保证不修改的sti界面图片调用原来的1024*768对应的界面图片
			SCREEN_WIDTH_1024 = 1024;
		...
		default:
			...
			iResY = 600;
			//zwwooooo: Big resolution: 保证800*600不出错 -->
			SCREEN_WIDTH_1024 = 800;
			SCREEN_HEIGHT_768 = 600;
			iResolution_BIG = 0;
			SCREEN_WIDTH_BIG = iResX;
			SCREEN_HEIGHT_BIG = iResY;
			//zwwooooo: Big resolution <--
