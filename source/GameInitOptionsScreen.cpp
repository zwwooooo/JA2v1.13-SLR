...
BOOLEAN		EnterGIOScreen()
{
	...
	else if (iResolution == 2)
	{
		...
		if (iResolution_BIG == 3) {
			FilenameForBPP("INTERFACE\\OptionsScreenBackGround_1280x768.sti", VObjectDesc.ImageFile);
		} else if (iResolution_BIG == 4) {
			FilenameForBPP("INTERFACE\\OptionsScreenBackGround_1280x800.sti", VObjectDesc.ImageFile);
		} else if (iResolution_BIG == 5) {
			FilenameForBPP("INTERFACE\\OptionsScreenBackGround_1280x960.sti", VObjectDesc.ImageFile);
		} else if (iResolution_BIG == 6) {
			FilenameForBPP("INTERFACE\\OptionsScreenBackGround_1280x1024.sti", VObjectDesc.ImageFile);
		} else if (iResolution_BIG == 7) {
			FilenameForBPP("INTERFACE\\OptionsScreenBackGround_1360x768.sti", VObjectDesc.ImageFile);
		} else if (iResolution_BIG == 8) {
			FilenameForBPP("INTERFACE\\OptionsScreenBackGround_1366x768.sti", VObjectDesc.ImageFile);
		} else if (iResolution_BIG == 9) {
			FilenameForBPP("INTERFACE\\OptionsScreenBackGround_1400x1050.sti", VObjectDesc.ImageFile);
		} else if (iResolution_BIG == 10) {
			FilenameForBPP("INTERFACE\\OptionsScreenBackGround_1600x900.sti", VObjectDesc.ImageFile);
		} else if (iResolution_BIG == 11) {
			FilenameForBPP("INTERFACE\\OptionsScreenBackGround_1680x1050.sti", VObjectDesc.ImageFile);
		} else if (iResolution_BIG == 12) {
			FilenameForBPP("INTERFACE\\OptionsScreenBackGround_1920x1080.sti", VObjectDesc.ImageFile);
		} else {
			FilenameForBPP("INTERFACE\\OptionsScreenBackGround_1024x768.sti", VObjectDesc.ImageFile);
		}
