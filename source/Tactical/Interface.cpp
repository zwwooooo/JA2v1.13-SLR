...
//**ddd{ 
//??ńň?a?ňü ????éí a 0 ?ń?? ?ń???ü??a?ňü á??ü??é ??????ńń á??
	...
	switch (iResolution)
	{
		...
		case 2:
			if (gGameExternalOptions.fSmallSizeProgressbar)
				...
				//zwwooooo: Big resolution: 根据分辨率来选择界面sti文件名称 -->
				if (iResolution_BIG == 3) {
					fn = "INTERFACE\\rect_1280x768Thin.sti";
				} else if (iResolution_BIG == 4) {
					fn = "INTERFACE\\rect_1280x800Thin.sti";
				} else if (iResolution_BIG == 5) {
					fn = "INTERFACE\\rect_1280x960Thin.sti";
				} else if (iResolution_BIG == 6) {
					fn = "INTERFACE\\rect_1280x1024Thin.sti";
				} else if (iResolution_BIG == 7) {
					fn = "INTERFACE\\rect_1360x768Thin.sti";
				} else if (iResolution_BIG == 8) {
					fn = "INTERFACE\\rect_1366x768Thin.sti";
				} else if (iResolution_BIG == 9) {
					fn = "INTERFACE\\rect_1400x1050Thin.sti";
				} else if (iResolution_BIG == 10) {
					fn = "INTERFACE\\rect_1600x900Thin.sti";
				} else if (iResolution_BIG == 11) {
					fn = "INTERFACE\\rect_1680x1050Thin.sti";
				} else if (iResolution_BIG == 12) {
					fn = "INTERFACE\\rect_1920x1080Thin.sti";
				} else {
					fn = "INTERFACE\\rect_1024x768Thin.sti";
				}
				...
				//zwwooooo: Big resolution: 根据分辨率来选择界面sti文件名称 -->
				if (iResolution_BIG == 3) {
					fn = "INTERFACE\\rect_1280x768.STI";
				} else if (iResolution_BIG == 4) {
					fn = "INTERFACE\\rect_1280x800.STI";
				} else if (iResolution_BIG == 5) {
					fn = "INTERFACE\\rect_1280x960.STI";
				} else if (iResolution_BIG == 6) {
					fn = "INTERFACE\\rect_1280x1024.STI";
				} else if (iResolution_BIG == 7) {
					fn = "INTERFACE\\rect_1360x768.STI";
				} else if (iResolution_BIG == 8) {
					fn = "INTERFACE\\rect_1366x768.STI";
				} else if (iResolution_BIG == 9) {
					fn = "INTERFACE\\rect_1400x1050.STI";
				} else if (iResolution_BIG == 10) {
					fn = "INTERFACE\\rect_1600x900.STI";
				} else if (iResolution_BIG == 11) {
					fn = "INTERFACE\\rect_1680x1050.STI";
				} else if (iResolution_BIG == 12) {
					fn = "INTERFACE\\rect_1920x1080.STI";
				} else {
					fn = "INTERFACE\\rect_1024x768.STI";
				}
				// <-- zwwooooo: Big resolution
	...
	switch (iResolution)
	{
		...
		case 2:
			if (gGameExternalOptions.fSmallSizeProgressbar)
				...
				//zwwooooo: Big resolution: 根据分辨率来选择界面sti文件名称 -->
				if (iResolution_BIG == 3) {
					fn = "INTERFACE\\timebargreen_1280x768Thin.sti";
				} else if (iResolution_BIG == 4) {
					fn = "INTERFACE\\timebargreen_1280x800Thin.sti";
				} else if (iResolution_BIG == 5) {
					fn = "INTERFACE\\timebargreen_1280x960Thin.sti";
				} else if (iResolution_BIG == 6) {
					fn = "INTERFACE\\timebargreen_1280x1024Thin.sti";
				} else if (iResolution_BIG == 7) {
					fn = "INTERFACE\\timebargreen_1360x768Thin.sti";
				} else if (iResolution_BIG == 8) {
					fn = "INTERFACE\\timebargreen_1366x768Thin.sti";
				} else if (iResolution_BIG == 9) {
					fn = "INTERFACE\\timebargreen_1400x1050Thin.sti";
				} else if (iResolution_BIG == 10) {
					fn = "INTERFACE\\timebargreen_1600x900Thin.sti";
				} else if (iResolution_BIG == 11) {
					fn = "INTERFACE\\timebargreen_1680x1050Thin.sti";
				} else if (iResolution_BIG == 12) {
					fn = "INTERFACE\\timebargreen_1920x1080Thin.sti";
				} else {
					fn = "INTERFACE\\timebargreen_1024x768Thin.sti";
				}
				// <-- zwwooooo: Big resolution
				...
				//zwwooooo: Big resolution: 根据分辨率来选择界面sti文件名称 -->
				if (iResolution_BIG == 3) {
					fn = "INTERFACE\\timebargreen_1280x768.sti";
				} else if (iResolution_BIG == 4) {
					fn = "INTERFACE\\timebargreen_1280x800.sti";
				} else if (iResolution_BIG == 5) {
					fn = "INTERFACE\\timebargreen_1280x960.sti";
				} else if (iResolution_BIG == 6) {
					fn = "INTERFACE\\timebargreen_1280x1024.sti";
				} else if (iResolution_BIG == 7) {
					fn = "INTERFACE\\timebargreen_1360x768.sti";
				} else if (iResolution_BIG == 8) {
					fn = "INTERFACE\\timebargreen_1366x768.sti";
				} else if (iResolution_BIG == 9) {
					fn = "INTERFACE\\timebargreen_1400x1050.sti";
				} else if (iResolution_BIG == 10) {
					fn = "INTERFACE\\timebargreen_1600x900.sti";
				} else if (iResolution_BIG == 11) {
					fn = "INTERFACE\\timebargreen_1680x1050.sti";
				} else if (iResolution_BIG == 12) {
					fn = "INTERFACE\\timebargreen_1920x1080.sti";
				} else {
					fn = "INTERFACE\\timebargreen_1024x768.sti";
				}
				// <-- zwwooooo: Big resolution
	...
	switch (iResolution)
	{
		...
		case 2:
			if (gGameExternalOptions.fSmallSizeProgressbar)
				...
				//zwwooooo: Big resolution: 根据分辨率来选择界面sti文件名称 -->
				if (iResolution_BIG == 3) {
					fn = "INTERFACE\\timebaryellow_1280x768Thin.sti";
				} else if (iResolution_BIG == 4) {
					fn = "INTERFACE\\timebaryellow_1280x800Thin.sti";
				} else if (iResolution_BIG == 5) {
					fn = "INTERFACE\\timebaryellow_1280x960Thin.sti";
				} else if (iResolution_BIG == 6) {
					fn = "INTERFACE\\timebaryellow_1280x1024Thin.sti";
				} else if (iResolution_BIG == 7) {
					fn = "INTERFACE\\timebaryellow_1360x768Thin.sti";
				} else if (iResolution_BIG == 8) {
					fn = "INTERFACE\\timebaryellow_1366x768Thin.sti";
				} else if (iResolution_BIG == 9) {
					fn = "INTERFACE\\timebaryellow_1400x1050Thin.sti";
				} else if (iResolution_BIG == 10) {
					fn = "INTERFACE\\timebaryellow_1600x900Thin.sti";
				} else if (iResolution_BIG == 11) {
					fn = "INTERFACE\\timebaryellow_1680x1050Thin.sti";
				} else if (iResolution_BIG == 12) {
					fn = "INTERFACE\\timebaryellow_1920x1080Thin.sti";
				} else {
					fn = "INTERFACE\\timebaryellow_1024x768Thin.sti";
				}
				// <-- zwwooooo: Big resolution
				...
				//zwwooooo: Big resolution: 根据分辨率来选择界面sti文件名称 -->
				if (iResolution_BIG == 3) {
					fn = "INTERFACE\\timebaryellow_1280x768.sti";
				} else if (iResolution_BIG == 4) {
					fn = "INTERFACE\\timebaryellow_1280x800.sti";
				} else if (iResolution_BIG == 5) {
					fn = "INTERFACE\\timebaryellow_1280x960.sti";
				} else if (iResolution_BIG == 6) {
					fn = "INTERFACE\\timebaryellow_1280x1024.sti";
				} else if (iResolution_BIG == 7) {
					fn = "INTERFACE\\timebaryellow_1360x768.sti";
				} else if (iResolution_BIG == 8) {
					fn = "INTERFACE\\timebaryellow_1366x768.sti";
				} else if (iResolution_BIG == 9) {
					fn = "INTERFACE\\timebaryellow_1400x1050.sti";
				} else if (iResolution_BIG == 10) {
					fn = "INTERFACE\\timebaryellow_1600x900.sti";
				} else if (iResolution_BIG == 11) {
					fn = "INTERFACE\\timebaryellow_1680x1050.sti";
				} else if (iResolution_BIG == 12) {
					fn = "INTERFACE\\timebaryellow_1920x1080.sti";
				} else {
					fn = "INTERFACE\\timebaryellow_1024x768.sti";
				}
				// <-- zwwooooo: Big resolution
